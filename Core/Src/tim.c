...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2 
    */
    HAL_GPIO_DeInit(QEI_M1_CH1_GPIO_Port, QEI_M1_CH1_Pin);

    HAL_GPIO_DeInit(QEI_M1_CH2_GPIO_Port, QEI_M1_CH2_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2 
    */
    HAL_GPIO_DeInit(GPIOB, QEI_M2_CH1_Pin|QEI_M2_CH2_Pin);
